export function AdminLoadingScreen({ message = "Preparing admin panel..." }: { message?: string }) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(circle_at_top,rgba(168,85,247,0.08),transparent_34%),linear-gradient(180deg,#121316,#1a1b1f)]">
